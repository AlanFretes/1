...
Class ModeloBlog{
	...
	static public function mdlCargarCorreo($tabla, $valor){

		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(correo) VALUES (:email_email)");

		$stmt -> bindParam(":email_email", $valor["email"], PDO::PARAM_STR);
