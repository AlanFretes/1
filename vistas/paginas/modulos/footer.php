					...
					<div class="container p-0">
						...
						<div class="d-flex">
							...
							<div class="d-flex flex-column columna1">
								...
								<figure class="p-2 m-0 photo1" vinculo="<?php echo $blog["dominio"].$categorias[0]["ruta_categoria"] ?>" style="background:url(<?php echo $blog["dominio"].$categorias[0]["img_categoria"] ?>)">
									
									<p class="text-uppercase p-1 p-md-2 p-xl-1 small"><?php echo $categorias[0]["titulo_categoria"] ?></p>

								</figure>

								<figure class="p-2 m-0 photo2" vinculo="<?php echo $blog["dominio"].$categorias[4]["ruta_categoria"] ?>" style="background:url(<?php echo $blog["dominio"].$categorias[4]["img_categoria"] ?>)">
							...
							<div class="d-flex flex-column flex-fill columna2">
								...
								<div class="d-block d-md-flex">
									...
									<figure class="p-2 m-0 flex-fill photo3" vinculo="<?php echo $blog["dominio"].$categorias[1]["ruta_categoria"] ?>" style="background:url(<?php echo $blog["dominio"].$categorias[1]["img_categoria"] ?>)">
									...
									<figure class="p-2 m-0 flex-fill photo4" vinculo="<?php echo $blog["dominio"].$categorias[3]["ruta_categoria"] ?>" style="background:url(<?php echo $blog["dominio"].$categorias[3]["img_categoria"] ?>)">
								...
								<figure class="p-2 m-0 photo5" vinculo="<?php echo $blog["dominio"].$categorias[2]["ruta_categoria"] ?>" style="background:url(<?php echo $blog["dominio"].$categorias[2]["img_categoria"] ?>)">
					...
					<form method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate"  novalidate>
						...
						<div class="mc-field-group">
							...
							<div class="input-group my-4">
								...
								<input type="email" name="email" class="form-control required email" id="mce-EMAIL" placeholder="Ingresa tu Email" required>
								...
								<div class="input-group-append">
									...
									$enviarEmail = ControladorBlog::ctrCargarCorreo();
									...
									if($enviarEmail == "ok"){
										...
										echo '<script>
											...
											notie.alert({
												type: 1,
												text: "El Email ha sido enviado correctamente, espere muy pronto una respuesta",
												time: 10
										...
										echo '<script>
											...
											notie.alert({
												type: 3,
												text: "No se pudo enviar el Email, inténtelo nuevamente",
												time: 10
